...
In GDI, a **dataset** is a comprehensive record that describes a genomic data resource that can be used to make it discoverable to researchers. For example, a genomic data resource for *COVID-19 Viral Sequences* can include datasets such as: *patient data*, *virus samples*, or *hospital study results*.  

**A dataset can have two sets of information:** 
- **[Metadata:](#metadata)** Descriptive information
- **[Data and resources:](#data-and-resources)** The actual genomic data files or services
...
These are the actual files, databases, or data services that contain the genomic information. This includes details pertaining to:
...
A dataset record for *"European Rare Disease Genomic Variants Study"* would include:

- **Metadata:** Study description, research institution contact, data collection period (2020-2023), access restrictions for patient privacy
- **Data and resources:** VCF files containing variant calls, phenotype data in CSV format, analysis scripts in R, and documentation PDFs—each with specific download URLs, file sizes, and technical details
