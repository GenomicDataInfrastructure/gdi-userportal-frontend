  ...
  `
    ...
    return (
        <CopyToClipboard text={queryToCopy} title={disabled ? 'submit to enable button' : ''} disabled={disabled}>
            <button
                type='button'
                className='-ml-px relative inline-flex items-center px-4 py-2 border border-black hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 rounded-r'
            >
                Copy query
            </button>
        </CopyToClipboard>
