...
The **GDI Data Catalogue** is the central management system for Europe's genomic dataset network. As part of the 1+ Million Genomes Initiative, this catalogue serves as the source for dataset information that the public can access through the [GDI Data Portal](https://portal.gdi.lu/)<sup>↗</sup>.
...
- **[Harvest datasets automatically](overview):** Set up automated harvesting from external sources like FAIR Data Points, DCAT-AP endpoints, or other CKAN catalogues to synchronise datasets continuously.
   ...
   All datasets you manage in this Data Catalogue are displayed in the **[GDI Data Portal](https://portal.gdi.lu/)**<sup>↗</sup>, making them discoverable to researchers across Europe. Your work ensures high-quality genomic data is available for research and clinical purposes.
