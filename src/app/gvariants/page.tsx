...
import GVariantsSearchBar, {SearchInputData} from "@/app/gvariants/GVariantsSearchBar";
...
export default function GVariantsPage({searchParams}: GVariantsPageProps) {
    ...
    return (
        <PageContainer searchParams={_searchParams} className="container mx-auto px-4 pt-5">
