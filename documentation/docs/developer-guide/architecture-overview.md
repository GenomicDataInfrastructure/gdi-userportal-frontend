...
Explore the GDI User Portal's multiple components that work together to provide a federated genomic data infrastructure.

## Core components

All components run on Docker containers, and their individual setups are documented in their respective repositories.
...
**Repository**: [User Portal Frontend](https://github.com/GenomicDataInfrastructure/gdi-userportal-frontend)
...
**Repository**: [Dataset Discovery Service](https://github.com/GenomicDataInfrastructure/gdi-userportal-dataset-discovery-service)
...
**Repository**: [Access Management Service](https://github.com/GenomicDataInfrastructure/gdi-userportal-access-management-service)
...
## Working with CKAN extensions

In order to contribute to a CKAN extension and run it on your local machine, it must be integrated into the Docker build that will run as your backend service, connected to your DDS instance. 

For a detailed guide on how to integrate the extension, read [5. Installing new extensions](https://github.com/GenomicDataInfrastructure/gdi-userportal-ckan-docker?tab=readme-ov-file#5-installing-new-extensions) from the [CKAN Docker repository](https://github.com/GenomicDataInfrastructure/gdi-userportal-ckan-docker).

## Next steps

- [Set up your development environment](./setup-environment/index.md)
- [Understand CKAN technology](./develop-extensions/ckan-resources.md)
- [View deployment options](./deploy-production/index.md)
