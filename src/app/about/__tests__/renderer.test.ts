...
describe("Renderer Tests", () => {
  it("should render a heading correctly", () => {
    ...
    if (renderer.heading) {
      const result = renderer.heading.call(renderer as any, token);
  ...
  it("should render a paragraph correctly", () => {
    ...
    if (renderer.paragraph) {
      const result = renderer.paragraph.call(renderer as any, token);
  ...
  it("should render an unordered list correctly", () => {
    ...
    if (renderer.list) {
      // @ts-ignore
      const result = renderer.list.call(renderer as any, token);
  ...
  it("should render a list item correctly", () => {
    ...
    if (renderer.listitem) {
      const result = renderer.listitem.call(renderer as any, token);
  ...
  it("should render a link correctly", () => {
    ...
    if (renderer.link) {
      const result = renderer.link.call(renderer as any, token);
