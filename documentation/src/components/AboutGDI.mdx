...
- **GDI Dataset Catalogue:** For data stewards, catalogue managers, and data managers
...
Dataset metadata published in the **Dataset Catalogue** becomes discoverable through the **User Portal**, creating a federated network where European genomic data remains distributed but searchable.
