...
const Section3: React.FC<SectionProps> = ({
  ...
  const [naturalPersonAffiliation, setNaturalPersonAffiliation] = useState("");
  ...
  useEffect(() => {
    if (applicationData?.form?.section3) {
      ...
      const publicSectorKey =
        section3.applyingForDataOnBehalfOfPublicSector?.key ?? "";
      setPublicSectorBody(
        publicSectorKey === "a" ? "yes" : publicSectorKey === "b" ? "no" : ""
      );

      const mandateTasksKey =
        section3.applyingForDataForCarryingOutTasks?.key ?? "";
      setMandateTasks(
        mandateTasksKey === "a" ? "yes" : mandateTasksKey === "b" ? "no" : ""
      );
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs italic text-gray-600">
              Tasks in your organization's/institution's mandate mean tasks
              based on national or European Union law.
            </span>
          </div>
          <div className="space-y-2">
            <div className="flex items-center">
        ...
        <div className="mt-8">
          ...
          <div className="mt-8">
            ...
            <p className="text-xs text-gray-600 mb-4 italic">
              ...
              forwarded to the controller during the processing of an
              application if additional information is required for defining the
              data extraction.
            </p>
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold text-gray-900 mb-1">
                ...
                applicant? (E.g. an employee applying for data on behalf of
                their organisation.) <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
