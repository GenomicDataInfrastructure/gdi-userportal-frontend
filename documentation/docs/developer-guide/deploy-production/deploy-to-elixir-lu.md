---
title: Deploy to ELIXIR Luxembourg
sidebar_position: 2
---
...
15. Wait for REMS Synchroniser or run it manually.
16. Access Keycloak.
17. Configure LS-AAI IdP.
18. Add `Claim to User Attribute` mapper, that maps the claim `sub` into `elixir_id`.
...
- [Deploy to Azure](./deploy-to-azure.md) - Azure deployment guide
