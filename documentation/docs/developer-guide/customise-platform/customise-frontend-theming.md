---
title: Customise frontend theming
sidebar_position: 1
---
...
# Frontend customisation documentation
...
Configure these options in the `properties.json` file:
...
- [Audit user activity](./audit-user-activity.md) - Enable activity tracking
