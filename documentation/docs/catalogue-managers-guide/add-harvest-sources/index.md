...
2. Fill out the harvest source form based on the source type you are connecting to.
   ...
   | **Update frequency** | How often the harvest runs:<br/>• **Manual:** You must select **Reharvest** each time<br/>• **Daily:** Runs at the end of each day<br/>• **Weekly:** Runs at the end of each week<br/>• **Biweekly:** Runs every two weeks<br/>• **Monthly:** Runs at the end of each month<br/>• **Always:** Runs continuously |
